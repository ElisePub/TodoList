  ...
  <nav class="navbar">
    ...
    <ul
      ...
      <template v-if="authStore.isLoggedIn">
        ...
        <li>
          <RouterLink class="navbar__route" to="/home">Home</RouterLink>
        </li>
        <li class="text-gray-300">
          |
        </li>
        ...
        <li>
          <RouterLink class="navbar__route" to="/favorites">Favorites</RouterLink>
        </li>
        <li class="text-gray-300">
          |
        </li>
    ...
    <template v-if="!authStore.isLoggedIn"> 
      <div class="navbar__log"> 
        <RouterLink to="/" class="navbar__log__login">
    ...
    <template v-if="sideBarOpen">
      <div class="navbar-menu relative z-10">
        ...
        <nav
          ...
          <div>
            <ul>
              <li class="mb-1" v-if="!authStore.isLoggedIn">
                <RouterLink class="navbar__mobile" to="/">Login</RouterLink>
                <RouterLink class="navbar__mobile" to="/register">Register</RouterLink>
              </li>
              <template v-if="authStore.isLoggedIn">
                <li class="mb-1">
                  <RouterLink to="/home" class="navbar__mobile" @click="hideSidebar">Home</RouterLink>
                </li>
                <li class="mb-1">
                  <RouterLink to="/favorites" class="navbar__mobile" @click="hideSidebar">Favorites</RouterLink>
                </li>
              </template>
            </ul>
          </div>
          ...
          <template v-if="authStore.isLoggedIn">
            <div class="mt-auto">
              <div class="pt-6">
                <RouterLink to="/" class="mobile__log" @click="hideSidebar(),signOutHandler()">Log Out</RouterLink>
              </div>
            </div>
          </template>
        </nav>
